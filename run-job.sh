# Variabel-variabel
FILE_JAR=target/uas-fadhil-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.0.8
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=uas-fadhil.jar
PACKAGE_ID=tahun.App
INPUT_FOLDER=/fadhil/disney/input
OUTPUT_FOLDER=/fadhil/disney/output
